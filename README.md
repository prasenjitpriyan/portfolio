...
<>
  <header id="header" className="header dark-background d-flex flex-column">
    ...
    <div className="profile-img">
      <img src="/myIMG.jpg" alt="logo" className="img-fluid rounded-circle" />
    </div>
    <Link
      href="index.html"
          ...
          <div className="col-lg-6" data-aos="fade-up" data-aos-delay={200}>
            ...
            <div className="resume-item">
              ...
              <ul>
                ...
                <li>
                  Managed up to 5 projects or tasks at Link given time while
                  under pressure
                </li>
                <li>
                ...
                <li>
                  Created 4+ design presentations and proposals Link month for
