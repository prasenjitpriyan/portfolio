...
const NotFoundPage = () => {
  return (
    <div className="w-full h-[calc(100svh-4rem)] flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 bg-my-color-4">
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        <p className="text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-my-color-6">
          404
        </p>
        <p className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-my-color-6 mt-2">
          Page Not Found
        </p>
        <p className="text-lg md:text-xl lg:text-2xl text-my-color-2 my-12">
          Sorry, the page you are looking for could not be found.
        </p>
        <Link
          href={'/'}
          className="flex items-center space-x-2 bg-my-color-3 text-gray-100 px-4 py-2 rounded transition duration-150"
          title="Return Home"
        >
          Return Home
        </Link>
      ...
      <div className="w-1/2 lg:h-full flex lg:items-end justify-center p-4">
        ...
        >
          <circle cx="212.592" cy="103" r="64" fill="#323330"></circle>
          <path
            fill="#f0db4f"
          ...
          <ellipse
            ...
            ry="10.97"
          ></ellipse>
          <circle cx="97.084" cy="566.27" r="79" fill="#2965f1"></circle>
          <path
            fill="#323330"
          ...
          <circle cx="99.319" cy="546.295" r="9" fill="#61dbfb"></circle>
          <path
            fill="#323330"
          ...
          ></path>
          <circle cx="712.485" cy="565.415" r="79" fill="#f06529"></circle>
          <path
            fill="#f0db4f"
          ...
          <circle cx="708.522" cy="545.71" r="9" fill="#61dbfb"></circle>
          <path
            fill="#323330"
