...
const NF = () => {
  return (
    <div class="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 bg-my-color-5">
      <div class="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        <p class="text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-my-color-6">
          404
        </p>
        <p class="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-my-color-6 mt-2">
          Page Not Found
        </p>
        ...
        <Link
          href={'/'}
          class="flex items-center space-x-2 bg-my-color-1 hover:bg-my-color-2 text-gray-100 px-4 py-2 rounded transition duration-150"
          title="Return Home"
        >
          <svg
      ...
      <div class="w-1/2 lg:h-full flex lg:items-end justify-center p-4">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="w-full text-my-color-1"
          data-name="Layer 1"
