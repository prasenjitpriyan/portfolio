...
const NotFoundPage = () => {
  return (
    <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 bg-my-color-2">
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        ...
        <p className="text-lg md:text-xl lg:text-2xl text-my-color-5 my-12">
      ...
      <div className="w-1/2 lg:h-full flex lg:items-end justify-center p-4">
        ...
        >
          <circle cx="212.592" cy="103" r="64" fill="#00ADB5"></circle>
          <path
            fill="#cbd5e1"
          ...
          <ellipse
            ...
            ry="10.97"
          ></ellipse>
          <circle cx="97.084" cy="566.27" r="79" fill="#f0db4f"></circle>
          <path
            fill="#f0db4f"
          ...
          <circle cx="99.319" cy="546.295" r="9" fill="#00ADB5"></circle>
          <path
            fill="#cbd5e1"
          ...
          ></path>
          <circle cx="712.485" cy="565.415" r="79" fill="#f0db4f"></circle>
          <path
            fill="#f0db4f"
          ...
          <circle cx="708.522" cy="545.71" r="9" fill="#00ADB5"></circle>
          <path
            fill="#cbd5e1"
