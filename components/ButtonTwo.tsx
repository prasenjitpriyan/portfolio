...
const ButtonTwo: React.FC<ButtonProps> = ({ text, icon, href, className }) => {
  ...
  return (
    <div className="relative group">
      ...
      <Link
        href={href}
        ref={linkRef}
        className={`relative inline-flex items-center text-white text-[15px] font-bold tracking-[0.5px] font-circular transition-all duration-300 group ${className}`}
      >
